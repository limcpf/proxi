...
describe("EchoFeedPage", () => {
  beforeEach(() => {
    ...
    vi.mocked(createEchoWithFiles).mockReset();
  ...
  it("Echo 작성 후 목록을 invalidate 한다", async () => {
    ...
    vi.mocked(createEchoWithFiles).mockResolvedValue(echo);
    ...
    expect(createEchoWithFiles).toHaveBeenCalledWith({
      body: "첫 Echo",
      files: [],
    });
